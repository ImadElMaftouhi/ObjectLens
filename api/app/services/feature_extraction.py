...
# You said you won't use dominant colors anymore; we can remove it later once compute_similarity is updated.
...
class FeatureExtractionService:
    ...
    # ✅ Updated defaults to match your new experiment settings
    DEFAULT_WEIGHTS = {
        "form": {"fourier": 0.6, "orientation": 0.4},
        "texture": {"tamura": 0.5, "gabor": 0.5},
        "color": {"hsv_histogram": 1.0},  # ✅ only HSV used
    }
